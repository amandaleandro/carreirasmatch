...
export default function MemoryGamePage() {
  ...
  function handleCardClick(cardId: number) {
    if (finished || flippedCards.length === 2) return;
            ...
            {cards.map((card) => {
              ...
              return (
                <button
                  ...
                  className={`h-24 sm:h-28 rounded-2xl border flex items-center justify-center text-center p-3 font-semibold text-xs sm:text-sm transition-all duration-300 transform cursor-pointer relative overflow-hidden ${
                    show
                      ? card.isMatched
                      ...
                      : "border-neutral-200 dark:border-neutral-800 bg-white hover:border-blue-300 dark:bg-neutral-900 text-transparent dark:text-transparent"
                  }`}
                >
                  ...
                  {!show && (
                    <div className="absolute inset-0 flex items-center justify-center text-neutral-300 dark:text-neutral-700 font-bold text-xl select-none">
                      ?
                    </div>
                  )}
                </button>
