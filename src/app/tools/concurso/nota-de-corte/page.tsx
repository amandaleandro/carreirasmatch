...
import { ConcursoCutoffForm } from "./ConcursoCutoffForm";

const TOOL_HREF = "/tools/concurso/nota-de-corte";

export default async function ConcursoCutoffPage() {
