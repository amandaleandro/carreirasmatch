...
import { CareerGrowthGuide } from "./CareerGrowthGuide";

const TOOL_HREF = "/tools/career-growth-guide";

export default async function CareerGrowthGuidePage() {
