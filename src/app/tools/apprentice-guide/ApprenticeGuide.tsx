...
import {
  APPRENTICE_GUIDE,
  APPRENTICE_GUIDE_BY_SECTION,
  type ApprenticeGuideSection,
} from "@/lib/apprentice-guide";

export function ApprenticeGuide() {
  const [section, setSection] = useState<ApprenticeGuideSection>("direitos_deveres");
  const content = APPRENTICE_GUIDE_BY_SECTION[section];
