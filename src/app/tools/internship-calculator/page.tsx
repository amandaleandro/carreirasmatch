...
import { InternshipCalculatorForm } from "./InternshipCalculatorForm";
import { requireSubscriptionPage } from "@/lib/require-subscription-page";
import { hasFullAccessEmail } from "@/lib/full-access-users";

const TOOL_HREF = "/tools/internship-calculator";

export default async function InternshipCalculatorPage() {
  ...
  return <InternshipCalculatorForm />;
}
