...
import { InternshipGuide } from "./InternshipGuide";

const TOOL_HREF = "/tools/internship-guide";

export default async function InternshipGuidePage() {
