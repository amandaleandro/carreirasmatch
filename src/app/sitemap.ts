...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/descobrir`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/aprender`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/conquistar`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE_URL}/evoluir`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/estagio/trilhas`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/empresas/diagnostico`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/plano-de-candidatura`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/rota-profissional`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/estudos`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/estudos/diagnostico`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
