  ...
  return (
    ...
    >
      <header className="mb-8 text-center lg:text-left">
        <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white">Entrar como parceiro</h1>
      </header>
      ...
      <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/95 dark:bg-neutral-950/95 shadow-lg shadow-slate-900/5 p-6 md:p-8">
        ...
        <p className="text-sm text-center text-neutral-600 dark:text-neutral-400 mt-5">
          Ainda não tem conta?{" "}
          <Link href="/parceiro/cadastro" className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">
