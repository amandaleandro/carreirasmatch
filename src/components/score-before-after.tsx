    ...
    <div className="rounded-3xl border border-blue-500/20 bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 p-6 md:p-8 text-white shadow-xl space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 items-center justify-between gap-6 py-2">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-1">
          <div className="inline-flex items-center gap-1 text-2xl font-black text-emerald-400 bg-emerald-500/10 px-4 py-1.5 rounded-2xl border border-emerald-500/30 shadow-lg animate-pulse">
            +{diff}%
          </div>
