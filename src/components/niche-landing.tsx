        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-12 grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-neutral-500 dark:text-neutral-400">
              <li><a href="#como-funciona" className="hover:text-neutral-800 dark:hover:text-white transition-colors">Como funciona</a></li>
              <li><a href="#recursos" className="hover:text-neutral-800 dark:hover:text-white transition-colors">Recursos</a></li>
              <li><a href="#planos" className="hover:text-neutral-800 dark:hover:text-white transition-colors">Planos</a></li>
            </ul>
          </div>
          <div>
