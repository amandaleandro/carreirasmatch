    ...
    <header className="public-header glass-header sticky top-0 z-30 transition-all">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            href="/login"
            className="rounded-md border border-slate-200 dark:border-slate-800 px-4.5 py-2 text-xs font-semibold text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all"
          >
            Entrar
          </Link>
          <Link
            href="/register"
            className="rounded-md bg-blue-600 text-white px-5 py-2 text-xs font-semibold hover:bg-blue-700 transition-all shadow-xs shadow-blue-600/20 active:scale-95"
          >
            Criar conta
          </Link>
        </div>
