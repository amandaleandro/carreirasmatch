...
export const TOOLS_CATALOG: ToolCatalogEntry[] = [
  ...
  {
    href: "/tools/leitor-edital",
    title: "Leitor de Edital Inteligente por IA",
    description: "Faça upload ou cole o texto do edital para extrair matérias, pesos e cronograma automático.",
    segments: ["concurseiro", "oab"],
    icon: "filePlus",
    color: "amber",
    accountFree: true,
  ...
  {
    href: "/tools/flashcards-anki",
    title: "Gerador de Flashcards de Revisão (ANKI)",
    description: "Crie cartões de memorização com algoritmo de repetição espaçada por disciplina.",
    segments: ["concurseiro", "oab", "student"],
    icon: "sparkles",
    color: "indigo",
    accountFree: true,
  },
  {
    href: "/tools/matriz-de-skills",
    title: "Matriz de Equivalência de Competências",
    description: "Traduza experiências de cargos antigos nos termos técnicos exigidos na sua nova área.",
    segments: ["career_change", "career_pro"],
    icon: "scale",
    color: "violet",
    accountFree: true,
  },
  {
    ...
    title: "LinkedIn Profile & Post Optimizer",
    description: "Gere títulos atraentes, seções Sobre completas e posts autorais para o seu LinkedIn.",
    segments: ["career_pro", "career_change", "first_job", "internship"],
    icon: "linkedin",
    color: "blue",
    accountFree: true,
  },
  {
    href: "/tools/extrator-soft-skills",
    title: "Extrator de Soft Skills & Projetos Pessoais",
    description: "Transforme trabalhos acadêmicos, liderança jovem e voluntariado em conquistas de currículo.",
    segments: ["apprentice", "first_job", "internship", "student"],
    icon: "sparkles",
    color: "emerald",
    accountFree: true,
  },
