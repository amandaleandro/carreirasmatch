...
export const INTERNSHIP_GUIDE: InternshipGuideSectionContent[] = [
  ...
  },
  {
    ...
    intro:
      "Currículo mostra o que você diz que sabe; portfólio mostra o que você realmente entregou. Para quem está começando, um portfólio simples e bem organizado pesa mais do que muitos projetos incompletos.",
    tips: [
      {
        title: "Escolha 2 a 4 projetos, não 20",
        body: "Um portfólio com poucos projetos bem explicados e finalizados passa mais confiança do que uma lista longa de projetos incompletos ou copiados de tutorial sem alteração.",
        action: "Liste todos os seus projetos hoje e escolha os 3 melhores para deixar em destaque.",
      },
      {
      ...
      },
      {
        ...
        action: "Escolha um projeto acadêmico e publique o código (com o README explicando o contexto) no GitHub.",
      },
      {
        title: "Organize o perfil do GitHub, não só os repositórios",
        body: "Foto, bio curta e repositórios fixados (\"pinned\") na página principal do perfil são a primeira coisa que um recrutador vê antes de clicar em qualquer projeto.",
        action: "Fixe (pin) seus 3 melhores repositórios no topo do seu perfil do GitHub.",
      },
      {
        title: "Sem projetos ainda? Comece por algo pequeno e real",
        body: "Um projeto pequeno mas funcional (automatizar uma tarefa do dia a dia, um site simples, uma planilha automatizada) vale mais do que nenhum projeto.",
        action: "Escolha uma tarefa chata do seu dia a dia e pense em como resolvê-la com um projeto pequeno esta semana.",
      },
    ],
  },
  {
