...
/** Sugestões de cursos e áreas de formação para estudantes e estagiários. */
export const COMMON_STUDY_AREAS: string[] = [
  ...
  "Odontologia",
  "Psicologia",
  "Relações Internacionais e Serviço Social",
  "Tecnologia da Informação",
  "Segurança Pública e Carreiras Militares",
  "Design",
