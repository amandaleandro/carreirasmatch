...
ARG NEXT_PUBLIC_ADSENSE_SLOT_BLOG_LIST
ARG NEXT_PUBLIC_ADSENSE_SLOT_JOBS_LIST
ARG NEXT_PUBLIC_ADSENSE_SLOT_TOOL_GUIDE
ENV NEXT_PUBLIC_MERCADOPAGO_PUBLIC_KEY=$NEXT_PUBLIC_MERCADOPAGO_PUBLIC_KEY \
    ...
    NEXT_PUBLIC_ADSENSE_SLOT_BLOG_ARTICLE=$NEXT_PUBLIC_ADSENSE_SLOT_BLOG_ARTICLE \
    NEXT_PUBLIC_ADSENSE_SLOT_BLOG_LIST=$NEXT_PUBLIC_ADSENSE_SLOT_BLOG_LIST \
    NEXT_PUBLIC_ADSENSE_SLOT_JOBS_LIST=$NEXT_PUBLIC_ADSENSE_SLOT_JOBS_LIST \
    NEXT_PUBLIC_ADSENSE_SLOT_TOOL_GUIDE=$NEXT_PUBLIC_ADSENSE_SLOT_TOOL_GUIDE
